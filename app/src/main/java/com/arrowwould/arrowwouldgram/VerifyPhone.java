...
public class VerifyPhone extends AppCompatActivity {
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty() || code.length() < 6) {
                    entercode.setError("Enter a valid code");
    ...
    private void sendverificationcode(String number) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                60L,
                TimeUnit.SECONDS,
                this,  // Pass the current Activity context
                mCallBack
        );
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack =
            new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                    ...
                    verificationId = s;
                    Log.d("VerifyPhone", "Code sent. Verification ID: " + verificationId);
                }
    ...
    // Method to verify the entered OTP code
    private void verifyCode(String code) {
        if (verificationId != null && code != null && !code.isEmpty()) {
            try {
    ...
    // Method to link the credential with the user's account
